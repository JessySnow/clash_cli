...
public enum RequestContainer {
    ...
    GET_VERSION("/version",
            RestfulMethod.GET,  null,  false,
            new Class[]{VersionHandler.class},  null, null),
    GET_PROXIES("/proxies",
            RestfulMethod.GET,
            null,
    ...
    GET_SPECIFIC_PROXY_INFO("/proxies/:name",
            RestfulMethod.GET,
            constructRequestParamMap(new HttpParamEntry[]{HttpParamEntry.PROXY}), false,
            new Class[]{NodeHandler.class}, null, null),
